...
public:
    RusGame(sf::Font& font, std::function<void(Screen*)> switchScreenCallback, std::string difficulty, std::wstring playerName);
    ~RusGame();

    void draw(sf::RenderWindow& window) override;
    void handleInput(sf::Event& event, sf::RenderWindow& window) override;
    void loadRussianWords(const std::string& filename);
...
private:
    ...
    std::unordered_set<std::wstring> russianWords;
};
